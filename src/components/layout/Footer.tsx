      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link to="/categories/lighting" className="text-gray-300 hover:text-white transition-colors">Lighting</Link></li>
              <li><Link to="/categories/switches" className="text-gray-300 hover:text-white transition-colors">Switches & Sockets</Link></li>
              <li><Link to="/categories/breakers" className="text-gray-300 hover:text-white transition-colors">Circuit Breakers</Link></li>
              <li><Link to="/categories/wires" className="text-gray-300 hover:text-white transition-colors">Wires & Cables</Link></li>
              <li><Link to="/categories/smart-home" className="text-gray-300 hover:text-white transition-colors">Smart Home Devices</Link></li>
            </ul>
          </div>
