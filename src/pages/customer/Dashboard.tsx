...
const CustomerDashboard = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        // In a real app, you would also fetch wishlist items and recently viewed products
  ...
  const removeFromWishlist = (productId: number) => {
    // In a real app, you would make a call to your backend to remove the item
              ...
              <CardContent>
                {cartItems.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">Browse our products and add items to your cart</p>
                    <Link to="/products">
